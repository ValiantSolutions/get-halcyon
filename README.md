...
<!--
  ...
  v0.1.0-rc.7 placeholders are replaced with the release tag at sync time.
-->
...
curl -fLO https://raw.githubusercontent.com/ValiantSolutions/get-halcyon/v0.1.0-rc.7/halcyon.sh
less halcyon.sh

# Recommended: verify the checksum against the value in your onboarding
# packet or the v0.1.0-rc.7 release notes
...
# Install
./halcyon.sh install-docker --tag v0.1.0-rc.7
...
sudo -E ./halcyon.sh install-ec2 --tag v0.1.0-rc.7
...
```bash
# Docker
./halcyon.sh upgrade-docker --tag v0.1.0-rc.7

# EC2
sudo -E ./halcyon.sh upgrade-ec2 --tag v0.1.0-rc.7
